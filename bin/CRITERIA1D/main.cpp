...
void usage()
{
    std::cout << "\nUsage:" << std::endl
              ...
              << "Date settings:" << std::endl
              << "- dates must be in the format YYYY-MM-DD" << std::endl
              << "- the default dates are the first and last dates of the data tables in the db_meteo file" << std::endl
              << "- in projects with grid-based weather data (MySQL), the default setting for lastDate is yesterday." << std::endl

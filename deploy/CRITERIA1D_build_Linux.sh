...
$QMAKE Makeall_CRITERIA1D.pro -spec linux-g++-64 CONFIG+=release CONFIG+=force_debug_info CONFIG+=c++17 CONFIG+=qtquickcompiler PREFIX=/usr
make -f Makefile clean
...
$QMAKE Makeall_CRITERIA1D_PRO.pro -spec linux-g++-64 CONFIG+=release CONFIG+=force_debug_info CONFIG+=c++17 CONFIG+=qtquickcompiler PREFIX=/usr
make -f Makefile clean
make -f Makefile qmake_all
make 
...
$QMAKE Makeall_SOIL_EDITOR.pro -spec linux-g++-64 CONFIG+=release CONFIG+=force_debug_info CONFIG+=c++17 CONFIG+=qtquickcompiler PREFIX=/usr
make -f Makefile clean
make -f Makefile qmake_all
make
...
$QMAKE Makeall_CRITERIAGEO.pro -spec linux-g++-64 CONFIG+=release CONFIG+=force_debug_info CONFIG+=c++17 CONFIG+=qtquickcompiler PREFIX=/usr
make -f Makefile clean
make -f Makefile qmake_all
make 
...
$QMAKE Makeall_HEAT1D.pro -spec linux-g++-64 CONFIG+=release CONFIG+=force_debug_info CONFIG+=c++17 CONFIG+=qtquickcompiler PREFIX=/usr
make -f Makefile clean
make -f Makefile qmake_all
make
